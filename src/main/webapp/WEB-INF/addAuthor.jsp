                                ...
                                <article class="page type-page status-publish hentry">
                                    <div class="entry-content">
                                        <div class="woocommerce">
                                            <form  class="checkout woocommerce-checkout" method="post" action="addAuthor">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="woocommerce-info">
                                                            <div class="col-sm-7">
                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="authorName" placeholder="Author Name"/>
                                                                </p>
                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="authorLastName" placeholder="Author Surname"/>
                                                                </p>
