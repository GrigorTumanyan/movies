                                ...
                                <article class="page type-page status-publish hentry">
                                    <div class="entry-content">
                                        <div class="woocommerce">
                                            <form  class="checkout woocommerce-checkout" method="post" action="addBook">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <%
                                                        ...
                                                        <div class="woocommerce-info">
                                                            <div class="col-sm-7">
                                                                <p>
                                                                <h4>Add book for <%=author.getName()%> <%=author.getSurname()%></h4>
                                                                </p>
                                                                <input type="hidden"  name="authorId" value=<%=author.getId()%>><br>
                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="bookName" placeholder="Book Name" />
                                                                </p>
