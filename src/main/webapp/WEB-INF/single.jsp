    ...
    <div class="container">
        ...
        <div class="w3_search">
            <form action="#" method="post">
                <input type="text" name="Search" placeholder="Փնտրել կայքում" required="">
                        ...
                        <div class="module form-module">
                            ...
                            <div class="form">
                                ...
                                <form action="loginServlet" method="post">
                                    <input type="text" name="email" placeholder="Էլ․ հասցե" required="">
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="../#" class="dropdown-toggle" data-toggle="dropdown">Ժանրեր<b class="caret"></b></a>
                            <ul class="dropdown-menu multi-column columns-3">
                                <li>
                                    <div class="col-sm-4">
                                        <ul class="multi-column-dropdown">
                                            <li><a href="genresServlet?genres=Մարտաֆիլմ">Մարտաֆիլմ</a></li>
                                            <li><a href="genresServlet?genres=Կրիմինալ">Կրիմինալ</a></li>
                                            <li><a href="genresServlet?genres=Ընտանեկան">Ընտանեկան</a></li>
                                            <li><a href="genresServlet?genres=Սարսափ">Սարսափ</a></li>
                                            <li><a href="genresServlet?genres=Ռոմանտիկ">Ռոմանտիկ</a></li>
                                            <li><a href="genresServlet?genres=Պատերազմական">Պատերազմական</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        <ul class="multi-column-dropdown">
                                            <li><a href="genresServlet?genres=7">Արկածային</a></li>
                                            <li><a href="genresServlet?genres=8">Հումորային</a></li>
                                            <li><a href="genresServlet?genres=9">Հոգեբանական</a></li>
                                            <li><a href="genresServlet?genres=10">Ֆանտաստիկ</a></li>
                                            <li><a href="genresServlet?genres=11">Թրիլլեր</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        <ul class="multi-column-dropdown">
                                            <li><a href="genresServlet?genres=12">Անիմացիոն</a></li>
                                            <li><a href="genresServlet?genres=13">Դրամմա</a></li>
                                            <li><a href="genresServlet?genres=14">Պատմական</a></li>
                                            <li><a href="genresServlet?genres=15">Փաստավավերագրական</a></li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
        ...
        <div class="single-page-agile-info">
            ...
            <div class="show-top-grids-w3lagile">
                        ...
                        <section >
                            <div  >
                                <video poster="../images/ckin.jpg" id="video-player"
                                       src="${movie.url}"
                                       data-ckin="default" data-overlay="1" controls ></video>
                            </div>
                        </section>
                ...
                <div class="col-md-4 single-right">
                    <h3>Up Next</h3>
                    <c:forEach var="next" items="${upNext}">
                    <div class="single-grid-right">
                            <div class="col-md-4 single-right-grid-left">
                                <a href="moviePage?idMovie=${next.id}"><img src="images/m1.jpg" alt=""/></a>
                            </div>
                            <div class="col-md-8 single-right-grid-right">
                                <a href="moviePage?idMovie=${next.id}" class="title">${next.name}</a>
