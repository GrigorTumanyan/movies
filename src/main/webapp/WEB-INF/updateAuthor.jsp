...
<html lang="zxx"><head>
    ...
    <![endif]-->
    <style type="text/css">@media screen and (max-width:991px) {.harvey-test{}}@media screen and (min-width:992px) {.harvey-test{}}</style></head>
                                ...
                                <article class="page type-page status-publish hentry">
                                    <div class="entry-content">
                                        <div class="woocommerce">
                                            <form  class="checkout woocommerce-checkout" method="post" action="update">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <%
                                                        ...
                                                        <div class="woocommerce-info">
                                                            <div class="col-sm-7">
                                                                ...
                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="authorId" value=<%=author.getId()%>>
                                                                </p>

                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="authorName" value=<%=author.getName()%>>
                                                                </p>
                                                                <p class="input-required">
                                                                    <input type="text" class="input-text" name="authorSurname" value=<%=author.getSurname()%>>
                                                                </p>
